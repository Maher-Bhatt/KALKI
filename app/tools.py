        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "action": {
                        "type": "string",
                        "description": "The action to perform: 'lock', 'sleep', 'restart', 'shutdown', 'volume_set', 'brightness_set', 'media_control', 'process_kill', 'battery_status', or 'open_app'."
                    },
                    "target": {
                        "type": "string",
                        "description": "Target parameter: app name (e.g., 'notepad'), volume level (0-100), brightness percentage (0-100), media command ('play_pause', 'next', 'previous', 'mute'), or process name to kill (e.g. 'chrome.exe')."
                    }
                },
                "required": ["action"]
            }
