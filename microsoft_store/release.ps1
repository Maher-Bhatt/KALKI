<##
.SYNOPSIS
    Build the KALKI 1.3.1 GitHub and Microsoft Store release artifacts.
.DESCRIPTION
...
$ReleaseDir = Join-Path $OutputDir 'release-v1.3.1'
$GitHubStage = Join-Path $OutputDir 'KALKI_v1.3.1_GitHub'
$GitHubZip = Join-Path $ReleaseDir 'KALKI_v1.3.1_GitHub.zip'
$MsixSource = Join-Path $OutputDir 'KALKI.msix'
$MsixRelease = Join-Path $ReleaseDir 'KALKI_v1.3.1.msix'
...
Write-Host '=== KALKI 1.3.1 Release Pipeline ===' -ForegroundColor Cyan
...
$portableReadme = @"
KALKI v1.3.1 — portable Windows package
