<##
.SYNOPSIS
    Build the KALKI 1.3.0 GitHub and Microsoft Store release artifacts.
.DESCRIPTION
...
$ReleaseDir = Join-Path $OutputDir 'release-v1.3.0'
$GitHubStage = Join-Path $OutputDir 'KALKI_v1.3.0_GitHub'
$GitHubZip = Join-Path $ReleaseDir 'KALKI_v1.3.0_GitHub.zip'
$MsixSource = Join-Path $OutputDir 'KALKI.msix'
$MsixRelease = Join-Path $ReleaseDir 'KALKI_v1.3.0.msix'
...
Write-Host '=== KALKI 1.3.0 Release Pipeline ===' -ForegroundColor Cyan
...
$portableReadme = @"
KALKI v1.3.0 — portable Windows package
