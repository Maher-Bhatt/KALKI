...
## v1.0.24 voice reliability and terms update
...
- Bumped runtime, updater, installer, EXE metadata, README, release notes, service-worker cache, and HUD labels to `v1.0.24`.
